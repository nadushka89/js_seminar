...
const user_input_celsii = Number.parseInt(prompt("Введите температуру в градусах Цельсия: "));
const user_input_farengeit = Math.round((9 / 5) * user_input_celsii + 32);
alert(`Цельсий: ${user_input_celsii}, Фаренгейт:${user_input_farengeit} `);
