...
const newProducts = products.filter((product) => product.photos && product.photos.length > 0);
console.log(newProducts);

const sortProducts = products.sort((product1, product2) => product1.price - product2.price);
